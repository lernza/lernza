...
export function QuestView({ questId, onBack }: QuestViewProps) {
  ...
  return (
    <div className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6">
      ...
      <Breadcrumb items={[{ label: "Quests", onClick: onBack }, { label: ws.name }]} />
      ...
      <div className="bg-background border-border animate-fade-in-up relative mb-8 overflow-hidden border shadow-lg">
        ...
        <div className="relative p-6">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h1 className="text-2xl font-semibold sm:text-3xl">{ws.name}</h1>
      ...
      {/* Tabs */}
      <div className="border-border mb-6 flex gap-0 border-b" ref={contentRef}>
