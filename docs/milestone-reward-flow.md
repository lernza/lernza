...
sequenceDiagram
    ...
    FE->>Wallet: Request authority signature for distribute_reward(authority, quest_id, learner, reward_amount)
    Wallet->>Rewards: distribute_reward(authority, quest_id, learner, reward_amount)
