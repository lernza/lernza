#![no_std]
use soroban_sdk::{contracttype, xdr::ScAddress, Address, Env, String, Vec};
...
/// Validate that an address is a Stellar contract address.
pub fn is_contract_address(addr: &Address) -> bool {
    matches!(ScAddress::from(addr), ScAddress::Contract(_))
}
