  ...
  return (
    <Card className="animate-fade-in-up">
      <CardContent className="flex flex-col items-center py-12 text-center">
        ...
        >
          <div className="bg-muted border-border mb-4 flex h-14 w-14 items-center justify-center border shadow-md">
    ...
    return (
      <Card className="animate-fade-in-up">
        <CardContent className="flex items-center gap-3 py-4">
          ...
          <div className="bg-accent border-border flex h-10 w-10 shrink-0 items-center justify-center border shadow-sm">
            {config.icon}
          </div>
