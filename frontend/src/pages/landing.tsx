...
export function Landing({ onNavigate }: LandingProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* CTA — lives on bg-accent so its internal decoration can stay semi-literal */}
      <section
        ref={ctaRef}
          ...
          <div className="grid grid-cols-1 gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="mb-4 flex items-center gap-3">
                <div className="bg-accent border-border flex h-8 w-8 items-center justify-center overflow-hidden border-2 shadow-sm">
                ...
                <span className="text-xl font-semibold">Lernza</span>
              </div>
            ...
            {/* Links */}
            <div>
              <h4 className="mb-4 text-sm font-semibold tracking-wider uppercase">Resources</h4>
            ...
            {/* Socials */}
            <div>
              <h4 className="mb-4 text-sm font-semibold tracking-wider uppercase">Community</h4>
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-card border-border neo-press hover:bg-accent flex h-10 w-10 items-center justify-center border-2 shadow-md transition-colors hover:shadow-md active:shadow-sm"
