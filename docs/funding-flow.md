...
This flow shows the quest authority funding a quest pool through the rewards contract. The rewards contract then moves tokens through the Stellar asset contract and updates the quest pool balance.
