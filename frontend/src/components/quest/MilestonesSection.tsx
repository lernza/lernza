  ...
  return (
    <div className="space-y-3">
      {milestones.map((milestone, index) => {
        ...
        const isLocked = milestone.prerequisiteIds.some(id => !completedSet.has(id))

        return (
          <div
            key={milestone.id}
            className={cn(
              "border-border bg-card flex flex-col gap-4 border p-5 shadow-md transition-all sm:flex-row sm:items-center",
          ...
          >
            ...
            <div className="flex flex-1 items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                {milestone.prerequisiteIds.length > 0 && (
            ...
            <div className="flex items-center gap-3 sm:justify-end">
              <div className="flex flex-col items-end gap-1">
                <Badge variant={isCompleted ? "success" : isLocked ? "secondary" : "default"} className="gap-1.5">
              ...
              {!isCompleted && !isLocked && (
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => onVerifyCompletion(milestone.id)}
                >
                  Verify
                </Button>
              )}
