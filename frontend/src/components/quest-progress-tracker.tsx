      ...
      {showConfetti && (
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          {confettiStyles.map((style, i) => (
            <div
              key={i}
              className="bg-accent animate-confetti absolute h-2 w-2"
              style={{
                left: style.left,
          ...
          {milestones.map((ms, i) => {
            ...
            return (
              <div
                key={ms.id}
                className={cn(
                  "border-border flex items-center gap-3 border p-3 transition-all",
              ...
              >
                <div
                  className={cn(
                    "border-border flex h-6 w-6 flex-shrink-0 items-center justify-center border",
